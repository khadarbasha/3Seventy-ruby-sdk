module ThreeSeventyApi
  module Api
    # Contact Api end point implementation goes here.
    ...
    module Contact
      ...
      # @option payload [String] Email (null, if PhoneNumber is present)Email address of the contact.
      # @option payload [Array<Object>] Subscriptions (null) List of subscriptions this contact should be opted into.
