module ThreeSeventyApi
  # Account Api end point implementation goes here.
  # @see https://staging-api.3seventy.com/docs/main/Default/endpoints#!/account
  module Account

    # List of all accounts that exisit for the user.
    # 
