module ThreeSeventyApi
  module Api
    module EventPushCampaign
      ...
      # @option payload [Array<Integer>] Targets (null) A list of targets to send to. These can be a mix of phone numbers, emails, or contact IDs.
      ...
      # @option payload [String] From (null) Used for email channel. Can specify From address or default will be used.
      # @option payload [String] Subject (null) Subject of the email.
